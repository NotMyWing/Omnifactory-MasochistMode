...
mods.actuallyadditions.Empowerer.addRecipe(<moreplates:empowered_restonia_gear>, <moreplates:restonia_gear>, <gregtech:meta_block_compressed_14:13>, <gregtech:meta_block_compressed_5:5>, <gregtech:meta_item_1:32762>.withTag({Fluid: {FluidName: "tritium", Amount: 1000}}), <extendedcrafting:material:13>, 1000000, 400);
...
//Sapphire block
mods.actuallyadditions.Empowerer.addRecipe(<moreplates:empowered_palis_gear>, <moreplates:palis_gear>, <gregtech:meta_block_compressed_9:13>, <thermalfoundation:storage:8>, <gregtech:meta_item_1:32762>.withTag({Fluid: {FluidName: "osmiridium", Amount: 1000}}), <extendedcrafting:material:10>, 1000000, 400);
...
//Apatite block
mods.actuallyadditions.Empowerer.addRecipe(<moreplates:empowered_enori_gear>, <moreplates:enori_gear>, <gregtech:meta_block_compressed_14:2>, <enderio:block_alloy:8>, <gregtech:meta_item_1:32762>.withTag({Fluid: {FluidName: "helium3", Amount: 1000}}), <extendedcrafting:material:8>, 1000000, 400);
...
//Uranium 238 Block
mods.actuallyadditions.Empowerer.addRecipe(<moreplates:empowered_emeradic_gear>, <moreplates:emeradic_gear>, <gregtech:meta_block_compressed_4:11>, <enderio:block_alloy:2>, <gregtech:meta_item_1:32762>.withTag({Fluid: {FluidName: "krypton", Amount: 1000}}), <extendedcrafting:material:11>, 1000000, 400);
